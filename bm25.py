...
class Bm25Vectorizer(CountVectorizer):
    ...
    BM25 Vectorizer
    """
    def __init__(self, input='content', b=0.75, k=1.2, encoding='utf-8',
        ...
        self._tfidf = Bm25Transformer(b=b, k=k, norm=norm, use_idf=use_idf,
    ...
    def transform(self, raw_documents, copy=True):
        ...
        X : sparse matrix, [n_samples, n_features]
            Tf-idf-weighted document-term matrix.
        """
        check_is_fitted(self, '_tfidf', msg='The tfidf vector is not fitted')
...
if __name__ == '__main__':
    ...
    Bm25 = Bm25Vectorizer(norm="l2", k=0.000001)
    ...
    Bm25.fit(data)
    ret = Bm25.transform(test)
    print("ret:\n", ret.toarray(), ret.shape)
    print("*" * 100)

    tfidf.fit(data)
    ret = tfidf.transform(test)
    print(ret.toarray(), ret.shape)
